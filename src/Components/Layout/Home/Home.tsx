...
export default function Home({ toggleDarkMode }: HomeProps): JSX.Element {
  ...
  return (
    <section id="hero" className="">
      <div className="relative h-screen px-2 py-3 section-container  overflow-hidden duration-500 h-[930px] tablet:h-[650px] laptop:h-[800px] laptop:p-3">
        {/* HEADER */}
        <header className="flex items-center justify-between px-3 pt-1 font-serif laptop:px-0 biggest:px-4">
          {/* Logo */}
          ...
          {/* <img
            src={LogoDark}
            className="w-48 h-14 contrast-100 brightness-100"
            alt="LogoImage"
          /> */}
          {/* MENU */}
        ...
        <div className="container mx-auto ">
          <div className="absolute z-20 top-72 w-[460px] pl-7 sm:pl-16 tablet:pl-4 tablet:space-y-32 space-y-40 tablet:top-32 laptop:space-y-32 laptop:left-6 mx-10 desktop:left-10 biggest:left-28">
            <div className="space-y-20 tablet:space-y-12 laptop:space-y-16 ">
              <div className="flex flex-col space-y-3 sm:px-4 tablet:px-0 tablet:space-y-0 sm:space-y-3 tablet:space-y-4 laptop:space-y-7">
               ...
               laptop:leading-[75px]  desktop:text-[110px] desktop:leading-[90px] "
                ...
                {/* tablet - screen */}
                <p
                  className="hidden tablet:flex text-[10px] w-[210px] leading-4  font-light tablet:leading-4 tablet:opacity-50 tablet:flex tablet:w-2/3 text-justify tablet:text-[10.5px] laptop:w-[390px] laptop:leading-5 laptop:text-sm desktop:text-[15px] opacity-70 desktop:w-[450px] desktop:text-[16px] font-serif desktop:leading-6 biggest:w-[480px]
                biggest:text-[17px]"
                >
                  We Specialise in producing bespoke, custom made garments for
                  every special occasion, with the best customer service next to
              ...
              {/* MOBILE BUTTON */}
              <Button
                className="text-xs  text-white tablet:hidden hover:scale-105 rounded-sm ml-4 py-3 px-20 duration-500 font-serif font-light tablet:ml-0 tablet:px-10 tablet:py-2 tablet:text-[10px] laptop:px-12 laptop:py-3 laptop:text-sm shadow shadow-3xl border border-slate-100 "
                type="button"
              >
                Get in touch
              </Button>
              ...
              <div className="flex flex-col hidden tablet:flex tablet:flex-row laptop:space-x-2 laptop:flex ">
                <Button
                  type="button"
                  className="px-10 py-3 laptop:px-12 font-serif text-xs text-white font-light duration-500 border border-none rounded-sm rounded-br-full shadow rounded-tr-3xl hover:scale-105 shadow-3xl cursor-pointer 
                  tablet:px-9 
                  tablet:text-[11px]
                  laptop:text-xs desktop:px-14 border-slate-100 bg-gradient-to-r from-[#E34CCE] to-[#E39B57]"
                >
                  Get in touch
                </Button>
                <Button
                  type="button"
                  className="flex gap-1 px-10 py-3 font-serif text-xs font-light duration-500 border border-none rounded-sm rounded-tl-full shadow cursor-pointer 
                  tablet:px-9 
                  tablet:text-[10px]
                  laptop:text-xs laptop:px-12 rounded-bl-3xl hover:scale-105 shadow-3xl desktop:px-14 dark:shadow-gray-100/5"
                >
                  View Collection
                </Button>
              </div>
            ...
            <div className="flex hidden w-5 h-5 space-x-2 tablet:flex tablet:pl-0 laptop:flex ">
              ...
              <img
                ...
                className="cursor-pointer transition-1000"
          ...
          <img
            src={HeroImage}
            alt="Hero Image"
            className="absolute z-10 h-[790px] -mt-10 duration-500 contrast-125 sm:absolute-none tablet:right-9 tablet:-mt-12 tablet:h-[600px] laptop:h-[730px] laptop:-mt-20 laptop:right-4 desktop:right-12 
            biggest:right-24
