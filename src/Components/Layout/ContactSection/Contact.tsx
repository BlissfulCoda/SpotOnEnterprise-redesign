  ...
  return (
    ...
    >
      ...
      <div className="relative flex flex-col p-4 mx-auto tablet:flex-row tablet:py-0 tablet:p-4 tablet:max-w-2xl tablet:min-h-[600px] laptop:max-w-5xl desktop:max-w-6xl laptop:px-32 sm:p-0 ">
        {/* FORM */}
        <form className="absolute z-10 w-11/12 px-5 py-10 space-y-8 bg-white shadow shadow-3xl tablet:w-80 tablet:absolute tablet:z-20 tablet:left-4 laptop:w-1/2 tablet:p-7 laptop:w-96 laptop:h-[500px] laptop:py-12 laptop:left-12 desktop:left-16 dark-color sm:w-full sm:py-14 dark:shadow-gray-100/10 ">
        ...
        <div className="relative pt-[400px] tablet:right-0 tablet:w-full tablet:pt-12 tablet:pl-48 bg-opacity-100  tablet:bg-opacity-100 dark-color ">
          {/* BOTTOM GRADIENT */}
          <div className="absolute bottom-0 left-0 right-0 top-[650px] gradient-bottom  tablet:top-[400px] tablet:opacity-100 bg-opacity-100 "></div>
          ...
          <iframe
            className="border-none h-[400px] w-full tablet:h-full tablet:rounded tablet:rounded-tr-3xl tablet:rounded-bl-3xl outline-none"
