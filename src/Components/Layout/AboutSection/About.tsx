...
function About(): JSX.Element {
  ...
  return (
    <section className="w-full py-20 mb-16 border bg-zinc-50 dark-color dark:border-y-slate-900 dark:border-x-0 dark:shadow dark:bg-shadow-xl border-y-slate-50">
