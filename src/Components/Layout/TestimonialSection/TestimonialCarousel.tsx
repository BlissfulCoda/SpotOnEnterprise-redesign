...
export default function TestimonialCarousel(): JSX.Element {
  ...
  return (
    <Card className="w-full h-[470px] sm:h-[520px] px-2 mx-auto tablet:w-full tablet:h-[410px]  tablet:w-96 laptop:h-[490px] desktop:h-[520px] biggest:h-[550px]">
      ...
      {/*--------- FEEDBACK LINE ---------*/}
      <span className="fixed flex items-center space-x-6 rotate-90 -left-36 top-64 sm:top-72 opacity-20 sm:-left-44 sm:pl-3 tablet:-left-32 tablet:pl-1 tablet:top-52 laptop:-left-40 desktop:-left-36">
