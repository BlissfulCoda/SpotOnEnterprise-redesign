...
export default function TestimonialCarousel(): JSX.Element {
  ...
  return (
    <Card className="w-full h-[450px] px-2 mx-auto tablet:w-1/2 tablet:p-0 tablet:w-96 ">
